<x-layout title="Sign up">
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Sign up</h2>
        </div>

        <form id="register" action="/register" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm/6 font-semibold text-gray-900">Confirmer le mot de passe</label>
                    <div class="mt-2.5">
                        <input 
                            type="password"
            ...
            <div class="mt-10 flex justify-center items-center">
                ...
                <x-button form="register">Sign up</x-button>
            </div>
        </form>
